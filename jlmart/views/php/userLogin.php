...
<body>
    ...
    <div class = "left">
        ...
        <button onclick="window.location.href='userRegister.php'" class="sign-up">Sign Up</button>
        </div>
    </div>
    ...
    <div class = "right">
        ...
        <form method="POST">
            ...
            <input type="text" id="username" name="username" placeholder ="Enter your email here" required><br><br>
            ...
            <label for="keep-logged-in" class ="keep">Keep me logged in</label><br></div>
